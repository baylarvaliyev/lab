...
export default async function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-bg">
      <div className="flex">
        <aside className="hidden w-60 shrink-0 border-r border-line-soft bg-bg-elev px-5 py-8 sm:block">
          ...
          <div className="mt-10 border-t border-line-soft pt-5">
            ...
            <form action={logoutAction}>
              <button className="focus-ring mt-2 text-[13.5px] font-medium text-gold hover:underline">
                Çıxış et
              </button>
            </form>
          </div>
